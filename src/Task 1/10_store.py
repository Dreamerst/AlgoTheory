...
sofa_cost1 = sofa_quantity1 * store[goods['Диван']][0]['price']
sofa_quantity2 = store[goods['Диван']][1]['quantity']
sofa_cost2 = sofa_quantity2 * store[goods['Диван']][1]['price']
...
chair_cost1 = chair_quantity1 * store[goods['Стул']][0]['price']
chair_quantity2 = store[goods['Стул']][1]['quantity']
chair_cost2 = chair_quantity2 * store[goods['Стул']][1]['price']
chair_quantity3 = store[goods['Стул']][2]['quantity']
chair_cost3 = chair_quantity3 * store[goods['Стул']][2]['price']
